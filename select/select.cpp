...
class Select
{
  public:
    ...
    bool Wait(std::vector<tcp_socket> &list, int timeout = 3000) {
      ...
      //因为select返回后集合中保存的都是就绪的描述符（没有就绪的已            经被移除）
